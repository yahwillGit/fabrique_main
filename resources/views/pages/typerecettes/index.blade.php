...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title">Type recette</h2> <br>
                    @can('addTypeRecette')
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="exampleFormModal{{$types->id}}" aria-hidden="false" aria-labelledby="exampleFormModalLabel"
                                        ...
                                        <div class="modal-dialog modal-simple">
                                            <form class="modal-content" action="{{route('typerecettes.update', $types->id)}}" method="post">
                                                @csrf
                                                @method('PUT')
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-body text-center">
                                                <form action="{{route('typerecettes.destroy', $types->id)}}" method="POST">
                                                    {{ method_field('delete') }}
                                                    {{ csrf_field() }}
    ...
    <div class="modal fade" id="addnew" aria-hidden="false" aria-labelledby="exampleFormModalLabel"
         role="dialog" tabindex="-1">
        <div class="modal-dialog modal-simple">
            <form class="modal-content" action="{{route('typerecettes.store')}}" method="post">
                @csrf
                @method('POST')
